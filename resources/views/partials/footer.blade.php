        <footer class="px-6 py-2 text-gray-100 bg-gray-800">
            <div class="container flex flex-col items-center justify-between mx-auto md:flex-row"><a href="#"
                    class="text-2xl font-bold">Lucas M.R.  -  A.C.S.</a>
                <p class="mt-2 md:mt-0">Tous droits réservés 2021.</p>
                <div class="flex mt-4 mb-2 -mx-2 md:mt-0 md:mb-0"><a href="https://www.linkedin.com/in/lucas-morille-roy/"
